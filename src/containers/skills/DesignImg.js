    ...
    return (
      ...
      >
        ...
        <g opacity="0.7">
          ...
          {/* Power BI Icon - Three bars */}
          <g transform="translate(765, 7.54)">
            <rect x="25" y="60" width="22" height="75" fill="#F2C811" />
            <rect x="55" y="80" width="22" height="55" fill="#E97627" />
            <rect x="85" y="95" width="22" height="40" fill="#FFB900" />
          </g>
        ...
        {/* Replace the Sketch diamond section with Tableau: */}
        <g opacity="0.7">
          {/* Tableau Logo - Modern T shape */}
          <g transform="translate(78, 11)">
            {/* Horizontal bar */}
            <rect x="0" y="30" width="113" height="12" fill="#E97627" />
            {/* Vertical bar */}
            <rect x="50" y="30" width="12" height="100" fill="#F28E2B" />
            {/* Top accent */}
            <rect x="20" y="20" width="30" height="8" fill="#59879B" />
            <rect x="62" y="20" width="30" height="8" fill="#59879B" />
            {/* Bottom accents */}
            <rect x="20" y="135" width="20" height="8" fill="#59879B" />
            <rect x="72" y="135" width="20" height="8" fill="#59879B" />
            {/* Center square */}
            <rect x="46" y="26" width="20" height="20" fill="#E97627" />
          </g>
